...
const Navbar = () => {
    ...
    return (
        ...
        <div>
        {user ? (
                    <  div className="z-[999] fixed top-[24px] right-10">
                        <div className="z-[999]">
                        <button
                        ...
                        {isOpen && (
                            ...
                            <ul className="py-2 text-sm text-gray-700 " aria-labelledby="dropdownAvatarNameButton">
                                    ...
                                    <li className="">
                                    <Link to="/" className="text-lg block px-4 py-2 hover:bg-[rgba(255,216,202,0.8)] ">
                                        Your Profile
                                    </Link>  
                                    </li>
                            ...
                            <div className="py-2">
                                    ...
                                    <Link onClick={handleLogout} className="text-lg block px-4 py-2 text-gray-700 hover:bg-[rgba(255,216,202,0.8)] ">
                                        Sign out
